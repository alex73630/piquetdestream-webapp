/*
  ...
  - Added the required column `userStateId` to the `User` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "userStateId" TEXT NOT NULL;
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_userStateId_fkey" FOREIGN KEY ("userStateId") REFERENCES "UserState"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
